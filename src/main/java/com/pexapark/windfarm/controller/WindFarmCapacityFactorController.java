...
public class WindFarmCapacityFactorController {
    ...
    public List<FarmValuePerDateVO> getCapacityFactor(@ApiParam("Start period date in format " + Constants.DEFAULT_DATE_FORMAT_TEMPLATE + ". Current date is used if nothing specified.")
